...
export default function Humildade() {
  ...
  const stages = {
    saber: {
      title: '📚 SABER - Conhecimento',
      subtitle: 'Compreenda o que é Humildade',
      color: 'from-blue-500 to-cyan-500',
      activities: [
        {
          id: 'teoria',
          type: 'Leitura',
          title: 'O que é Humildade?',
        ...
        },
        {
          ...
          description: 'Explore as variáveis do orgulho: vaidade, arrogância, controle...',
          icon: '🗺️',
          points: 50
        },
        {
      ...
      activities: [
        {
          id: 'diario-orgulho',
          type: 'Diário',
          title: 'Diário do Orgulho',
          description: 'Anote situações que te deixam nervoso, triste ou com raiva',
          icon: '📔',
          points: 100,
          duration: '7 dias'
        },
        ...
        },
        {
          ...
          description: 'Ajude alguém sem esperar reconhecimento',
          icon: '🤝',
          points: 150,
          duration: '5 ações'
        },
        ...
        },
        {
          ...
          description: 'Repita as afirmações da humildade',
          icon: '🗣️',
          points: 50,
          duration: '21 dias'
        }
      ...
      activities: [
        {
          id: 'autoavaliacao',
          type: 'Avaliação',
          title: 'Autoavaliação Profunda',
          description: 'Identifique suas expressões de orgulho',
          icon: '🔍',
          points: 200
        },
        {
          ...
          description: 'Crie estratégias para dominar o orgulho',
          icon: '📋',
          points: 200
        },
        {
        ...
        },
        {
          ...
          description: 'Ensine sobre humildade para alguém',
          icon: '👥',
          points: 300
        }
      ]
      ...
      activities: [
        {
          id: 'certificacao',
          type: 'Certificação',
          title: 'Certificação de Maestria',
          description: 'Demonstre domínio da virtude',
          icon: '🎓',
          points: 1000
        },
        {
          ...
          description: 'Inspire outros com sua transformação',
          icon: '📢',
          points: 500
        },
        {
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-4 gap-4 mb-8">
          {(['saber', 'fazer', 'ser', 'ter'] as Stage[]).map((stage, index) => {
            ...
            const isCompleted = false; // TODO: implementar lógica
                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      {activity.duration {activity.duration ? ({activity.duration ? ( activity.duration !== "" ? (
